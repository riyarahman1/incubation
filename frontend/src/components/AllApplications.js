                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td><button className={list.status === "PENDING" ? "btn" : list.status === "DECLINED" ? "btn btn-rounded btn-danger btn-xxs" : list.status === "APPROVED" ? "btn btn-rounded btn-success btn-xxs" : "btn btn-rounded btn-info btn-xxs"}>{list.status}</button></td>
